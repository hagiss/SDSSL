...
class PLLearner(pl.LightningModule):
    ...
    def forward(self, x):
        ...
        noise = torch.normal(0, 1, size=(image_one.shape[0], self.student.net.embed_dim)).to(self.device)
...
def main(args):
    ...
    if args.arch in vits.__dict__.keys():
        ...
        teacher = vits.__dict__[args.arch](img_size=[image_size], patch_size=args.patch_size, dis_token=args.dis_token,)
